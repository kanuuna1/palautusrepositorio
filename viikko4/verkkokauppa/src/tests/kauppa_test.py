...
class TestKauppa(unittest.TestCase):
    ...
    def test_kaksi_eri_ostosta_toimii(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_kaksi_samaa_ostosta_toimii(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
    ...
    def test_tuotetta_on_ja_toinen_loppu_toimii(self):
